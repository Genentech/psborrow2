...
Let's reformat our data.frame into a matrix. `psborrow2` has a helper function to assist us with this: `create_data_matrix.` Look at the help files, then fill in the
...
###
If we have no prior knowledge, we should make a wide prior such as a normal distribution with wide standard deviation. Look at the help article for `normal_prior()` to see how to create such a wide prior:
