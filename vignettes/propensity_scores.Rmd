...
<img src="figure-propensity_scores-loveplot-1.png" alt="plot of chunk loveplot" style="display: block; margin: auto;" />
...
#> Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'mcmc_sample': object 'analysis_att' not found
```
...
#> Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'mcmc_sample': object 'analysis_match' not found
```
...
#> Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'mcmc_sample': object 'analysis_iptw_bdb' not found
```
...
#> Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'mcmc_sample': object 'analysis_pp01' not found
```
...
#> Inputs look good.
#> NOTE: dropping column `ext` for full borrowing.
#> Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'mcmc_sample': CmdStan path has not been set yet. See ?set_cmdstan_path.
...
#> Error in eval(expr, envir, enclos): object 'result_none' not found
```
...
#> Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'plot': object 'models' not found
for (i in 2:7) {
