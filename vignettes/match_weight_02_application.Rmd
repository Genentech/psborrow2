...
#>           Age   Weight   Height Biomarker1 Biomarker2 Smoker Sex ECOG1 group
#> [1,] 55.51419 148.5092 65.63899   33.71898   55.26178      0   1     0     1
#> [2,] 49.93326 146.9441 63.44883   35.65828   45.50928      1   1     1     1
#> [3,] 58.51588 153.5435 70.53193   35.53710   55.89283      0   1     0     0
#> [4,] 48.61226 147.2873 64.10615   31.17663   55.80523      0   1     0     1
#> [5,] 51.84943 151.0312 62.16361   33.99677   48.01981      0   1     0     0
#> [6,] 51.81743 148.1115 68.69766   33.82398   47.32652      1   1     0     0
...
#> 1 lp__     -709.     -709.     1.50   1.30   -712.       -707.     1.00   10252.
#> 2 beta_trt   -0.0370   -0.0373 0.117  0.117    -0.230       0.157  1.00   12902.
#> 3 tau         0.0838    0.0370 0.122  0.0506    0.000343    0.326  1.00   12113.
#> 4 alpha[1]   -0.945    -0.943  0.0992 0.0996   -1.11       -0.784  1.00   12636.
#> 5 alpha[2]    2.56      2.58   0.316  0.314     2.01        3.05   1.00   18595.
#> 6 HR_trt      0.970     0.963  0.114  0.113     0.795       1.17   1.00   12902.
...
![plot of chunk unnamed-chunk-10](figure-match_weight_02_application-unnamed-chunk-10-1.png)
...
![plot of chunk unnamed-chunk-10](figure-match_weight_02_application-unnamed-chunk-10-2.png)
...
#>   <chr>                                     <dbl>    <dbl>
#> 1 lp__                               -713.        -707.   
#> 2 treatment log HR                     -0.266        0.195
#> 3 commensurability parameter            0.0000886    0.428
#> 4 baseline log hazard rate, internal   -1.14        -0.754
#> 5 baseline log hazard rate, external    1.90         3.14 
#> 6 treatment HR                          0.767        1.21
```
...
![plot of chunk unnamed-chunk-12](figure-match_weight_02_application-unnamed-chunk-12-1.png)
...
#> Error: `weib_ph_surv_dist()` is deprecated. Use `outcome_surv_weibull_ph()` instead.
...
#> Error: `borrowing_details()` is deprecated. Use `borrowing_hierarchical_commensurate()` for dynamic borrowing, else `borrowing_none()` or `borrowing_full()`.
...
#> Error: `normal_prior()` is deprecated. Use `prior_normal()` instead.
treatment
#> Treatment object
#> 
#> Treatment flag column: group 
...
![plot of chunk unnamed-chunk-19](figure-match_weight_02_application-unnamed-chunk-19-1.png)
...
![plot of chunk unnamed-chunk-19](figure-match_weight_02_application-unnamed-chunk-19-2.png)
...
![plot of chunk unnamed-chunk-21](figure-match_weight_02_application-unnamed-chunk-21-1.png)
...
#>                   mean         sd          2.5%           25%           50%
#> alpha     7.672650e-01 0.08330851  6.030597e-01  7.109502e-01  7.679483e-01
#> beta     -8.006893e-01 0.05042475 -8.986307e-01 -8.356531e-01 -8.005683e-01
#> deviance  2.200010e+08 1.86370178  2.200009e+08  2.200010e+08  2.200010e+08
#>                    75%         97.5%     Rhat n.eff
#> alpha     8.249207e-01  9.219494e-01 1.000049  1500
#> beta     -7.651435e-01 -7.026286e-01 1.000307  1500
#> deviance  2.200010e+08  2.200010e+08 1.000000     1
```
...
#> 0.3871170 0.4335912 0.4490737 0.4495901 0.4652671 0.5259439 0.4071268 0.4952818
```
...
![plot of chunk unnamed-chunk-31](figure-match_weight_02_application-unnamed-chunk-31-1.png)
...
![plot of chunk unnamed-chunk-32](figure-match_weight_02_application-unnamed-chunk-32-1.png)![plot of chunk unnamed-chunk-32](figure-match_weight_02_application-unnamed-chunk-32-2.png)
...
#>                   mean         sd          2.5%           25%           50%
#> alpha     7.012442e-01 0.08417559  5.422684e-01  6.433417e-01  6.995345e-01
#> alphaR    3.775493e+00 0.53271370  2.651884e+00  3.434386e+00  3.808735e+00
#> beta     -7.699118e-01 0.04937989 -8.653964e-01 -8.023713e-01 -7.688038e-01
#> deviance  2.200009e+08 3.59110530  2.200009e+08  2.200009e+08  2.200009e+08
#> tau       4.990748e-02 0.19141621  2.688540e-04  3.312027e-03  1.147687e-02
#>                    75%         97.5%     Rhat n.eff
#> alpha     7.626370e-01  8.639186e-01 1.002131   940
#> alphaR    4.142427e+00  4.781330e+00 1.002836   840
#> beta     -7.368342e-01 -6.755448e-01 1.000972  1500
#> deviance  2.200009e+08  2.200009e+08 1.000000     1
#> tau       3.066659e-02  2.970125e-01 1.001709  1200
```
...
#>      Min.   1st Qu.    Median      Mean   3rd Qu.      Max.      2.5%     97.5% 
#> 0.3924743 0.4482647 0.4635673 0.4636176 0.4786268 0.5455878 0.4208848 0.5088791
```
The histogram of the treatment hazard ratio can also be produced.
...
![plot of chunk unnamed-chunk-42](figure-match_weight_02_application-unnamed-chunk-42-1.png)
...
![plot of chunk unnamed-chunk-43](figure-match_weight_02_application-unnamed-chunk-43-1.png)
...
![plot of chunk unnamed-chunk-44](figure-match_weight_02_application-unnamed-chunk-44-1.png)![plot of chunk unnamed-chunk-44](figure-match_weight_02_application-unnamed-chunk-44-2.png)![plot of chunk unnamed-chunk-44](figure-match_weight_02_application-unnamed-chunk-44-3.png)![plot of chunk unnamed-chunk-44](figure-match_weight_02_application-unnamed-chunk-44-4.png)
...
#> Error: `exp_surv_dist()` is deprecated. Use `outcome_surv_exponential()` instead.
...
```r
#Borrowing
borrowing <- borrowing_details(method="No borrowing",
  ext_flag_col = "ext"
)
#> Error: `borrowing_details()` is deprecated. Use `borrowing_hierarchical_commensurate()` for dynamic borrowing, else `borrowing_none()` or `borrowing_full()`.
...
![plot of chunk unnamed-chunk-51](figure-match_weight_02_application-unnamed-chunk-51-1.png)
...
![plot of chunk unnamed-chunk-53](figure-match_weight_02_application-unnamed-chunk-53-1.png)
...
```r
#Borrowing
borrowing <- borrowing_details(method="Full borrowing",
                               ext_flag_col = "ext")
#> Error: `borrowing_details()` is deprecated. Use `borrowing_hierarchical_commensurate()` for dynamic borrowing, else `borrowing_none()` or `borrowing_full()`.
...
![plot of chunk unnamed-chunk-60](figure-match_weight_02_application-unnamed-chunk-60-1.png)
...
![plot of chunk unnamed-chunk-62](figure-match_weight_02_application-unnamed-chunk-62-1.png)
...
#>     0, ])
#> 
#>   n= 600, number of events= 367 
#> 
#>           coef exp(coef) se(coef)      z Pr(>|z|)
#> group -0.02944   0.97099  0.11673 -0.252    0.801
#> 
#>       exp(coef) exp(-coef) lower .95 upper .95
#> group     0.971       1.03    0.7724     1.221
#> 
...
#> 
#>   n= 1100, number of events= 703 
#> 
#>           coef exp(coef) se(coef)      z Pr(>|z|)    
#> group -0.98910   0.37191  0.08018 -12.34   <2e-16 ***
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
#> 
#>       exp(coef) exp(-coef) lower .95 upper .95
#> group    0.3719      2.689    0.3178    0.4352
#> 
#> Concordance= 0.662  (se = 0.007 )
#> Likelihood ratio test= 158.1  on 1 df,   p=<2e-16
#> Wald test            = 152.2  on 1 df,   p=<2e-16
#> Score (logrank) test = 162.7  on 1 df,   p=<2e-16
```
...
<tbody>
  <tr>
   <td style="text-align:left;"> Exponential distribution (constant hazard) and gamma prior </td>
   <td style="text-align:right;"> 0.9703 </td>
   <td style="text-align:right;"> 0.7665 </td>
   <td style="text-align:right;"> 1.2148 </td>
  </tr>
  <tr>
   <td style="text-align:left;"> Piecewise exponential distribution (proportional hazard) and power prior </td>
   <td style="text-align:right;"> 0.4496 </td>
   <td style="text-align:right;"> 0.4071 </td>
   <td style="text-align:right;"> 0.4953 </td>
  </tr>
  <tr>
   <td style="text-align:left;"> Weibull distribution (proportional hazard) and gamma prior </td>
   <td style="text-align:right;"> NA </td>
   <td style="text-align:right;"> NA </td>
   <td style="text-align:right;"> NA </td>
  </tr>
  <tr>
   <td style="text-align:left;"> Piecewise exponential distribution (proportional hazard) and commensurate prior </td>
   <td style="text-align:right;"> 0.4636 </td>
   <td style="text-align:right;"> 0.4209 </td>
   <td style="text-align:right;"> 0.5089 </td>
  </tr>
  <tr>
   <td style="text-align:left;"> Exponential distribution (constant hazard): No borrowing </td>
   <td style="text-align:right;"> -0.9451 </td>
   <td style="text-align:right;"> -1.1435 </td>
   <td style="text-align:right;"> -0.7542 </td>
  </tr>
  <tr>
   <td style="text-align:left;"> Exponential distribution (constant hazard): Full borrowing </td>
   <td style="text-align:right;"> -0.9451 </td>
   <td style="text-align:right;"> -1.1435 </td>
   <td style="text-align:right;"> -0.7542 </td>
  </tr>
  <tr>
   <td style="text-align:left;"> Cox model (Frequentist approach): No borrowing </td>
   <td style="text-align:right;"> 0.9710 </td>
   <td style="text-align:right;"> 0.7724 </td>
   <td style="text-align:right;"> 1.2206 </td>
  </tr>
  <tr>
   <td style="text-align:left;"> Cox model (Frequentist approach): Full borrowing </td>
...
<tfoot>
<tr>
<td style = 'padding: 0; border:0;' colspan='100%'><sup></sup> CI: Credible Interval for Bayesian methods and Confidence interval for Frequentist method</td>
</tr>
</tfoot>
</table>
