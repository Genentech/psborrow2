...
#> make[1]: *** [/var/folders/r8/rnwp6vls7t97nz0w0_d18cpc0000gn/T/Rtmpr3ngkz/model-1623373f600c5.o] Error 1
...
#> If your model failed to compile please run rebuild_cmdstan().
#> If the issue persists please open a bug report.
#> make[1]: *** [/var/folders/r8/rnwp6vls7t97nz0w0_d18cpc0000gn/T/Rtmpr3ngkz/model-162336c589958.o] Error 1
#> Error: An error occured during compilation! See the message above for more information.
```
...
#> If your model failed to compile please run rebuild_cmdstan().
#> If the issue persists please open a bug report.
#> make[1]: *** [/var/folders/r8/rnwp6vls7t97nz0w0_d18cpc0000gn/T/Rtmpr3ngkz/model-1623370822c64.o] Error 1
#> Error: An error occured during compilation! See the message above for more information.
```
...
#> If your model failed to compile please run rebuild_cmdstan().
#> If the issue persists please open a bug report.
#> make[1]: *** [/var/folders/r8/rnwp6vls7t97nz0w0_d18cpc0000gn/T/Rtmpr3ngkz/model-162333938101c.o] Error 1
#> Error: An error occured during compilation! See the message above for more information.
```
