---
title: "2. Matching and Weighting Application"
...
#> Inputs look good.
#> error: PCH file was compiled for the target 'x86_64-apple-macosx13.0.0' but the current translation unit is being compiled for target 'x86_64-apple-macosx14.0.0'
#> 1 error generated.
...
#> make[1]: *** [/var/folders/r8/rnwp6vls7t97nz0w0_d18cpc0000gn/T/RtmpIh4GYP/model-1120e58c3f352.o] Error 1
...
#> Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'mcmc_sample': object 'anls_obj' not found

draws1 <- results.exp.psborrow$draws()
#> Error in eval(expr, envir, enclos): object 'results.exp.psborrow' not found
draws1 <- rename_draws_covariates(draws1, anls_obj)
#> Error in eval(expr, envir, enclos): object 'draws1' not found
```
...
#> If your model failed to compile please run rebuild_cmdstan().
#> If the issue persists please open a bug report.
#> make[1]: *** [/var/folders/r8/rnwp6vls7t97nz0w0_d18cpc0000gn/T/RtmpIh4GYP/model-1120e2b31e958.o] Error 1
#> Error: An error occured during compilation! See the message above for more information.
```
...
#> Error in eval(expr, envir, enclos): object 'results.weib.psborrow' not found
draws2 <- rename_draws_covariates(draws2, anls_obj)
#> Error in eval(expr, envir, enclos): object 'draws2' not found
```
...
#> If your model failed to compile please run rebuild_cmdstan().
#> If the issue persists please open a bug report.
#> make[1]: *** [/var/folders/r8/rnwp6vls7t97nz0w0_d18cpc0000gn/T/RtmpIh4GYP/model-1120e188e9398.o] Error 1
#> Error: An error occured during compilation! See the message above for more information.
```
...
#> Error in eval(expr, envir, enclos): object 'results.no.psborrow' not found
draws3 <- rename_draws_covariates(draws3, anls_obj)
#> Error in eval(expr, envir, enclos): object 'draws3' not found
```
...
#> If your model failed to compile please run rebuild_cmdstan().
#> If the issue persists please open a bug report.
#> make[1]: *** [/var/folders/r8/rnwp6vls7t97nz0w0_d18cpc0000gn/T/RtmpIh4GYP/model-1120e1ec1ca46.o] Error 1
#> Error: An error occured during compilation! See the message above for more information.
```
...
#> Error in eval(expr, envir, enclos): object 'results.full.psborrow' not found
draws4 <- rename_draws_covariates(draws4, anls_obj)
#> Error in eval(expr, envir, enclos): object 'draws4' not found
```
...
#> Error in eval(expr, envir, enclos): object 'hr1' not found
...
#> Error in eval(expr, envir, enclos): object 'hr3' not found
...
#> Error in eval(expr, envir, enclos): object 'hr5' not found
...
#> Error in eval(expr, envir, enclos): object 'hr6' not found
...
#> Error in eval(expr, envir, enclos): object 'hr1.conf' not found
