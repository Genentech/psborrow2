...
#> 1 lp__     -718.    -718.     1.49   1.28   -721.       -716.     1.00   10631.
#> 2 beta_trt   -0.359   -0.360  0.109  0.108    -0.536      -0.176  1.00   13963.
#> 3 tau         0.120    0.0531 0.179  0.0723    0.000497    0.468  1.00   12567.
#> 4 alpha[1]   -0.619   -0.618  0.0908 0.0904   -0.773      -0.475  1.00   13720.
#> 5 alpha[2]    2.36     2.38   0.370  0.361     1.71        2.93   1.00   18458.
#> 6 HR_trt      0.703    0.698  0.0773 0.0755    0.585       0.839  1.00   13963.
...
#>   <chr>                                    <dbl>    <dbl>
#> 1 lp__                               -722.       -716.   
#> 2 treatment log HR                     -0.572      -0.141
#> 3 commensurability parameter            0.000113    0.624
#> 4 baseline log hazard rate, internal   -0.803      -0.448
#> 5 baseline log hazard rate, external    1.56        3.02 
#> 6 treatment HR                          0.565       0.869
```
...
#> Total execution time: 82.2 seconds.
...
#>   variable          mean   median     sd    mad       q5      q95  rhat ess_bulk
#>   <chr>            <dbl>    <dbl>  <dbl>  <dbl>    <dbl>    <dbl> <dbl>    <dbl>
#> 1 lp__          -708.    -7.07e+2 1.67   1.49   -7.11e+2 -706.     1.00   11161.
#> 2 beta_trt        -0.304 -3.03e-1 0.111  0.112  -4.84e-1   -0.120  1.00   16356.
#> 3 shape_weibull    0.836  8.36e-1 0.0322 0.0317  7.83e-1    0.889  1.00   21704.
#> 4 tau              0.177  7.56e-2 0.281  0.104   6.44e-4    0.688  1.00   14385.
#> 5 alpha[1]        -0.508 -5.07e-1 0.0931 0.0934 -6.63e-1   -0.357  1.00   16280.
#> 6 alpha[2]         1.97   1.99e+0 0.380  0.373   1.32e+0    2.56   1.00   19904.
#> 7 HR_trt           0.743  7.38e-1 0.0826 0.0827  6.16e-1    0.887  1.00   16356.
#> # ℹ 1 more variable: ess_tail <dbl>
```
...
#>   <chr>                                    <dbl>     <dbl>
#> 1 lp__                               -712.       -705.    
#> 2 treatment log HR                     -0.517      -0.0851
#> 3 Weibull shape parameter               0.774       0.900 
#> 4 commensurability parameter            0.000151    0.929 
#> 5 baseline log hazard rate, internal   -0.694      -0.330 
#> 6 baseline log hazard rate, external    1.17        2.65  
#> 7 treatment HR                          0.596       0.918
```
...
#>   variable     mean   median     sd    mad       q5      q95  rhat ess_bulk
#>   <chr>       <dbl>    <dbl>  <dbl>  <dbl>    <dbl>    <dbl> <dbl>    <dbl>
#> 1 lp__     -727.    -727.    0.982  0.694  -729.    -726.     1.00   10388.
#> 2 beta_trt   -0.355   -0.355 0.109  0.108    -0.533   -0.178  1.00    9046.
#> 3 alpha      -0.623   -0.622 0.0906 0.0905   -0.775   -0.476  1.00    9092.
#> 4 HR_trt      0.705    0.701 0.0769 0.0761    0.587    0.837  1.00    9046.
#> # ℹ 1 more variable: ess_tail <dbl>
```
...
#>   <chr>                       <dbl>    <dbl>
#> 1 lp__                     -730.    -726.   
#> 2 treatment log HR           -0.568   -0.141
#> 3 baseline log hazard rate   -0.804   -0.451
#> 4 treatment HR                0.567    0.869
```
...
#>   variable     mean   median     sd    mad       q5      q95  rhat ess_bulk
#>   <chr>       <dbl>    <dbl>  <dbl>  <dbl>    <dbl>    <dbl> <dbl>    <dbl>
#> 1 lp__     -747.    -747.    0.994  0.716  -749.    -746.     1.00   14116.
#> 2 beta_trt   -1.51    -1.51  0.0768 0.0773   -1.64    -1.39   1.00   12217.
#> 3 alpha       0.534    0.535 0.0468 0.0467    0.456    0.611  1.00   12320.
#> 4 HR_trt      0.221    0.220 0.0170 0.0170    0.194    0.250  1.00   12217.
#> # ℹ 1 more variable: ess_tail <dbl>
```
...
#>   <chr>                       <dbl>    <dbl>
#> 1 lp__                     -750.    -746.   
#> 2 treatment log HR           -1.67    -1.36 
#> 3 baseline log hazard rate    0.442    0.625
#> 4 treatment HR                0.189    0.256
```
...
<tbody>
  ...
  <tr>
   ...
   <td style="text-align:right;"> 0.9184 </td>
  </tr>
  <tr>
