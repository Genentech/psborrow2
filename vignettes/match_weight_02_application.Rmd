...
#> Error in `traceplot()`:
#> ! could not find function "traceplot"
```
...
#> Error:
#> ! object 'out' not found
#> Error in `add_footnote()`:
#> ! could not find function "add_footnote"
```
