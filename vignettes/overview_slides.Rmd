...
trt_from_anls <- function(borrowing, adjustment = NULL) {
  ...
  tibble(
    ...
    borrowing = ifelse(borrowing@method != "BDB_HCP",
      borrowing@method,
      paste0(
        borrowing@method,
        " - ",
...
bdb_borrow <- borrowing_details(method = "BDB_HCP", ext_flag_col = "ext", tau_prior = gamma_prior(0.001, 0.001))
bdb_borrow_agg <- borrowing_details(method = "BDB_HCP", ext_flag_col = "ext", tau_prior = gamma_prior(1, 0.001))
