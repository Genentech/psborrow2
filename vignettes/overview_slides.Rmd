...
tbl_cross(
  ...
  trt,
  ext,
  label = list(trt ~ "Experimental treatment flag",
...
This exmaple `data_list` object is a 
...
my_data_list <- list(
  lapply(1:100, function(z) sim_single_matrix(true_hr = 0.6, drift_hr = 1.0)),
  lapply(1:100, function(z) sim_single_matrix(true_hr = 1.0, drift_hr = 1.0)),
  lapply(1:100, function(z) sim_single_matrix(true_hr = 0.6, drift_hr = 1.5)),
  lapply(1:100, function(z) sim_single_matrix(true_hr = 1.0, drift_hr = 1.5))
)
```
