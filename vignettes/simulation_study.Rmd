...
![Figure 1](C:/Users/jink4/Bristol Myers Squibb/Yang, Zhi - External Control Borrowing Working Group\Genentech collaboration\Apr2024_NIH_conference/data_list.jpg){width=80%}
...
```
##      id ext trt      time status cnsr
## [1,]  1   0   0  5.064186      1    0
## [2,]  2   0   0  1.734691      1    0
## [3,]  3   0   0  3.816314      1    0
## [4,]  4   0   0  8.869366      1    0
## [5,]  5   0   0 23.292081      1    0
## [6,]  6   0   0  3.802180      1    0
```
...
## 1     0.6       No drift HR  1                   10
## 2     1.0       No drift HR  2                   10
## 3     0.6 Moderate drift HR  3                   10
## 4     1.0 Moderate drift HR  4                   10
```
...
```
## Simulation object with  16  combinations and  160  analyses ready to sample.  This is a lot of combinations/analyses! Consider breaking the  study into different simulation objects. Or if you  prefer to use these combinations, call `mcmc_sample()` next.
```
...
## 1      0.6       No drift HR  1                   10          default
## 2      1.0       No drift HR  2                   10          default
## 3      0.6 Moderate drift HR  3                   10          default
## 4      1.0 Moderate drift HR  4                   10          default
## 5      0.6       No drift HR  1                   10          default
## 6      1.0       No drift HR  2                   10          default
## 7      0.6 Moderate drift HR  3                   10          default
## 8      1.0 Moderate drift HR  4                   10          default
## 9      0.6       No drift HR  1                   10          default
## 10     1.0       No drift HR  2                   10          default
## 11     0.6 Moderate drift HR  3                   10          default
## 12     1.0 Moderate drift HR  4                   10          default
## 13     0.6       No drift HR  1                   10          default
## 14     1.0       No drift HR  2                   10          default
## 15     0.6 Moderate drift HR  3                   10          default
## 16     1.0 Moderate drift HR  4                   10          default
...
## 1       No borrowing      No adjustment            default 0.06375600
## 2       No borrowing      No adjustment            default 0.06344470
## 3       No borrowing      No adjustment            default 0.06346777
## 4       No borrowing      No adjustment            default 0.06239393
## 5     Full borrowing      No adjustment            default 0.02564888
## 6     Full borrowing      No adjustment            default 0.02587308
##     mse_mean   bias_mean null_coverage true_coverage
## 1 0.04507703 0.045569887           0.5             1
## 2 0.17216598 0.149958706           1.0             1
## 3 0.09317867 0.147219849           0.8             1
## 4 0.09396857 0.027528022           1.0             1
## 5 0.01210678 0.008835847           0.0             1
## 6 0.06348567 0.081642491           1.0             1
```
...
![plot of chunk unnamed-chunk-19](figure-simulation_study-unnamed-chunk-19-1.png)
...
![plot of chunk unnamed-chunk-20](figure-simulation_study-unnamed-chunk-20-1.png)
...
![plot of chunk unnamed-chunk-21](figure-simulation_study-unnamed-chunk-21-1.png)
...
![plot of chunk unnamed-chunk-22](figure-simulation_study-unnamed-chunk-22-1.png)
...
We can also compare designs for accuracy on the basis of their Euclidean distance to the ideal design by minimizing the type I and type II errors (Zabor, E. C. et al. (2022).). We can visualize the accuracy of any design using a scatterplot displaying type I error rate on the x-axis and power (1 -type II error rate) on the y-axis. A perfectly accurate design approaches the point (0, 1), representing no type I error and power of one.
...
![plot of chunk unnamed-chunk-23](figure-simulation_study-unnamed-chunk-23-1.png)
