...
# [1,]  1   0   0 10.1064470      1    0
# [2,]  2   0   0 10.8196190      1    0
# [3,]  3   0   0 20.5424122      1    0
# [4,]  4   0   0 16.4291712      1    0
# [5,]  5   0   0  8.7275857      1    0
# [6,]  6   0   0  0.2065971      1    0
```
...
simulation_obj
# Simulation object with  16  combinations and  1600  analyses ready to sample.  This is a lot of combinations/analyses! Consider breaking the  study into different simulation objects. Or if you  prefer to use these combinations, call `mcmc_sample()` next.
```
...
This evaluation took about 19.8
...
# 1       No borrowing      No adjustment            default 0.05915273
# 2       No borrowing      No adjustment            default 0.13032971
# 3       No borrowing      No adjustment            default 0.04724394
# 4       No borrowing      No adjustment            default 0.13079915
# 5     Full borrowing      No adjustment            default 0.02027734
# 6     Full borrowing      No adjustment            default 0.05067948
#    bias_mean null_coverage true_coverage
# 1 0.06270199          0.58          0.96
# 2 0.03916893          0.96          0.96
# 3 0.01524864          0.44          0.96
# 4 0.03571795          0.95          0.95
# 5 0.02150292          0.10          0.96
# 6 0.01040672          0.97          0.97
```
...
<img src="figure/simulation_study-unnamed-chunk-20-1.png" alt="plot of chunk unnamed-chunk-20" style="display: block; margin: auto;" />
...
<img src="figure/simulation_study-unnamed-chunk-21-1.png" alt="plot of chunk unnamed-chunk-21" style="display: block; margin: auto;" />
...
<img src="figure/simulation_study-unnamed-chunk-22-1.png" alt="plot of chunk unnamed-chunk-22" style="display: block; margin: auto;" />
