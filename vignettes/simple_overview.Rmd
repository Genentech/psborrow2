...
##  lp__     -1617.88 -1617.57 1.46 1.26 -1620.63 -1616.15 1.00     2064     2139
##  beta_trt    -0.16    -0.16 0.20 0.20    -0.48     0.18 1.00     2309     3093
##  tau          1.22     0.52 1.90 0.71     0.01     4.81 1.00     2200     1384
##  alpha[1]    -3.36    -3.35 0.16 0.16    -3.63    -3.10 1.00     2258     2756
##  alpha[2]    -2.40    -2.40 0.05 0.05    -2.49    -2.31 1.00     2950     3001
##  HR_trt       0.87     0.85 0.18 0.17     0.62     1.19 1.00     2309     3093
```
...
## 2 treatment log HR                      -0.540      -0.160     0.230
## 3 commensurability parameter             0.00145     0.520     6.46 
## 4 baseline log hazard rate, internal    -3.69       -3.35     -3.05 
## 5 baseline log hazard rate, external    -2.51       -2.40     -2.29 
## 6 treatment HR                           0.583       0.852     1.26
```
...
##   <chr>                       <dbl>    <dbl>     <dbl>
## 1 lp__                     -466.    -462.    -459.    
## 2 treatment log HR           -0.740   -0.349    0.0540
## 3 baseline log hazard rate   -4.71    -4.19    -3.72  
## 4 ps_cat_low                 -0.370    0.398    1.12  
## 5 ps_cat_low_med              0.456    0.995    1.55  
## 6 ps_cat_high_med             1.45     2.10     2.74  
## 7 ps_cat_high                 2.42     3.00     3.62  
## 8 treatment HR                0.477    0.705    1.06
```
...
##  2 treatment log HR                      -0.688     -0.349    -0.0250
##  3 commensurability parameter             0.0873    50.3    1368.    
##  4 baseline log hazard rate, internal    -4.68      -4.21     -3.78  
##  5 baseline log hazard rate, external    -4.69      -4.22     -3.81  
##  6 ps_cat_low                            -0.285      0.285     0.868 
##  7 ps_cat_low_med                         0.643      1.08      1.55  
##  8 ps_cat_high_med                        1.65       2.12      2.61  
##  9 ps_cat_high                            2.53       2.96      3.45  
## 10 treatment HR                           0.502      0.705     0.975
```
