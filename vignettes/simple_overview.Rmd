...
##  lp__     -1617.96 -1617.61 1.47 1.26 -1620.86 -1616.24 1.00      402      416
##  beta_trt    -0.15    -0.16 0.20 0.21    -0.46     0.20 1.00      490      651
##  tau          1.17     0.49 1.89 0.66     0.01     4.59 1.00      392      484
##  alpha[1]    -3.36    -3.35 0.16 0.17    -3.63    -3.11 1.00      493      474
##  alpha[2]    -2.40    -2.39 0.06 0.06    -2.49    -2.31 1.00      808      640
##  HR_trt       0.88     0.85 0.18 0.18     0.63     1.22 1.00      490      651
```
...
## 2 treatment log HR                      -0.526      -0.162     0.244
## 3 commensurability parameter             0.00153     0.490     5.98 
## 4 baseline log hazard rate, internal    -3.69       -3.35     -3.06 
## 5 baseline log hazard rate, external    -2.51       -2.39     -2.29 
## 6 treatment HR                           0.591       0.850     1.28
```
...
##   <chr>                       <dbl>    <dbl>     <dbl>
## 1 lp__                     -466.    -462.    -460.    
## 2 treatment log HR           -0.733   -0.342    0.0396
## 3 baseline log hazard rate   -4.69    -4.20    -3.65  
## 4 ps_cat_low                 -0.382    0.414    1.11  
## 5 ps_cat_low_med              0.400    0.999    1.57  
## 6 ps_cat_high_med             1.41     2.11     2.75  
## 7 ps_cat_high                 2.37     3.02     3.62  
## 8 treatment HR                0.480    0.710    1.04
```
...
##    variable                                `2.5%`     `50%`    `97.5%`
##    <chr>                                    <dbl>     <dbl>      <dbl>
##  1 lp__                               -1427.      -1420.    -1418.    
##  2 treatment log HR                      -0.641      -0.339    -0.0430
##  3 commensurability parameter             0.00555    64.5    1202.    
##  4 baseline log hazard rate, internal    -4.65       -4.16     -3.78  
##  5 baseline log hazard rate, external    -4.70       -4.16     -3.79  
##  6 ps_cat_low                            -0.307       0.230     0.895 
##  7 ps_cat_low_med                         0.633       1.02      1.57  
##  8 ps_cat_high_med                        1.69        2.06      2.63  
##  9 ps_cat_high                            2.53        2.91      3.44  
## 10 treatment HR                           0.527       0.712     0.958
```
