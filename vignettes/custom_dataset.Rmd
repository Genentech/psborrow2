...
```{r}
treatment_details(trt_flag_col = "trt",
...
anls_obj <- create_analysis_obj(
  ...
  outcome = exp_surv_dist(time_var = "time", 
                          cens_var = "cnsr"),
  borrowing = borrowing_details(method = "BDB",
                  baseline_prior = normal_prior(0, 1000), 
                  ext_flag_col = "ext",
                  tau_prior = gamma_prior(0.001, 0.001)),
