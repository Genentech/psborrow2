...
proper prior distributions on all parameters must be specified. `psborrow2`
...
plot(conservative_tau, xlim = c(0, 2000), ylim = c(0, 1e-03))
```

```{r}
aggressive_tau <- gamma_prior(1, 0.001)
plot(aggressive_tau, xlim = c(0, 2000), ylim = c(0, 1e-03))
