...
#> make[1]: *** [/var/folders/r8/rnwp6vls7t97nz0w0_d18cpc0000gn/T/RtmpwRRWPV/model-50d22d659a12.o] Error 1
...
#> If your model failed to compile please run rebuild_cmdstan().
#> If the issue persists please open a bug report.
#> make[1]: *** [/var/folders/r8/rnwp6vls7t97nz0w0_d18cpc0000gn/T/RtmpwRRWPV/model-50d279ef444c.o] Error 1
#> Error: An error occured during compilation! See the message above for more information.
```
...
#> If your model failed to compile please run rebuild_cmdstan().
#> If the issue persists please open a bug report.
#> make[1]: *** [/var/folders/r8/rnwp6vls7t97nz0w0_d18cpc0000gn/T/RtmpwRRWPV/model-50d22fb5ab1.o] Error 1
#> Error: An error occured during compilation! See the message above for more information.
```
...
#> If your model failed to compile please run rebuild_cmdstan().
#> If the issue persists please open a bug report.
#> make[1]: *** [/var/folders/r8/rnwp6vls7t97nz0w0_d18cpc0000gn/T/RtmpwRRWPV/model-50d24af9d71f.o] Error 1
#> Error: An error occured during compilation! See the message above for more information.
```
