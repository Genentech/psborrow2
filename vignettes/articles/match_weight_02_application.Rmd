---
title: "Bayesian dynamic borrowing method"
...
vignette: >
  %\VignetteIndexEntry{2. Matching and Weighting Application}
...
In the previous vignette, we had used various matching/weighting methods to minimize selection bias. In this vignette, we will use matched/weighted cohort for Bayesian dynamic borrowing. This vignette is a follow-up to the matching/weighting vignette, which demonstrates methods to mitigate selection bias when designing externally controlled trial. In this vignette, we will illustrate Bayesian dynamic borrowing approaches using the matched and weighted cohort. We will use the `psborrow2`[@psborrow2] R package to demonstrate the use of Bayesian methods with an example for time to event outcome. In addition to using `psborrow2` package, we will also demonstrate how to implement power and commensurate prior models with piecewise exponential baseline hazard function.

We consider the following time to event outcome models in this vignette
...
![plot of chunk unnamed-chunk-10](articles/figure-match_weight_02_application-unnamed-chunk-10-1.png)
...
![plot of chunk unnamed-chunk-10](articles/figure-match_weight_02_application-unnamed-chunk-10-2.png)
...
![plot of chunk unnamed-chunk-12](articles/figure-match_weight_02_application-unnamed-chunk-12-1.png)
...
![plot of chunk unnamed-chunk-19](articles/figure-match_weight_02_application-unnamed-chunk-19-1.png)
...
![plot of chunk unnamed-chunk-19](articles/figure-match_weight_02_application-unnamed-chunk-19-2.png)
...
![plot of chunk unnamed-chunk-21](articles/figure-match_weight_02_application-unnamed-chunk-21-1.png)
...
#> Warning in file(modfile, "rt"): cannot open file 'powerprior.txt': No such file
#> or directory
#> Error in file(modfile, "rt") : cannot open the connection
#> Error in jags.model(model.file, data = data, inits = init.values, n.chains = n.chains, : Cannot open model file "powerprior.txt"
```
...
#> Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'traceplot': object 'model1' not found
```
...
model2 <- jags(data = d.jags, model.file = "commensurateprior.txt", inits = i.jags, n.chains = 3,
               parameters=p.jags,n.iter=niter,n.burnin = round(niter/2),n.thin = 10)
#> Warning in file(modfile, "rt"): cannot open file 'commensurateprior.txt': No
#> such file or directory
#> Error in file(modfile, "rt") : cannot open the connection
#> Error in jags.model(model.file, data = data, inits = init.values, n.chains = n.chains, : Cannot open model file "commensurateprior.txt"
```
...
#> Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'traceplot': object 'model2' not found
```
...
![plot of chunk unnamed-chunk-51](articles/figure-match_weight_02_application-unnamed-chunk-51-1.png)
...
![plot of chunk unnamed-chunk-53](articles/figure-match_weight_02_application-unnamed-chunk-53-1.png)
...
![plot of chunk unnamed-chunk-60](articles/figure-match_weight_02_application-unnamed-chunk-60-1.png)
...
![plot of chunk unnamed-chunk-62](articles/figure-match_weight_02_application-unnamed-chunk-62-1.png)
...
#> Error in eval(expr, envir, enclos): object 'model1' not found
hr2.conf=c(hr2)
#> Error in eval(expr, envir, enclos): object 'hr2' not found
...
#> Error in eval(expr, envir, enclos): object 'model2' not found
hr4.conf=c(hr4)
#> Error in eval(expr, envir, enclos): object 'hr4' not found
...
#> Error in eval(expr, envir, enclos): object 'hr2.conf' not found
