---
title: "Getting started with `psborrow2`"
...
In this article, you'll learn about the scope of `psborrow2` and where to find
...
[Viele et. al. 2014](https://doi.org/10.1002/pst.1589)
...
Refer to the "custom dataset" vignette for more information on
how to implement BDB analyses on your own data:
`vignette('custom dataset', package = 'psborrow2')`
...
designs: `vignette('simulation study', package = 'psborrow2')`

## Additional information
`psborrow2` is the predecessor to
[`psborrow`](https://cran.r-project.org/web/packages/psborrow/index.html).
While the core functionality has been replicated in `psborrow2`, we cite it here
for posterity.
