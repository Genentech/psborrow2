...
```r
poisson_enrollment <- new("DataSimEnrollment", fun = function(n) rpois(n, lambda = 5))
...
#>   }
#> <bytecode: 0x7f79b3fe3270>
#> <environment: 0x7f79b3fe8668>
#> 
#> $score_rounded
#> function(data) round(data$score)
#> <bytecode: 0x7f79b58157e8>
#> 
#> 
#> 
#> Slot "coefficients":
...
#>     }
#> <bytecode: 0x7f79b4754ba8>
#> <environment: 0x7f79b475ee80>
#> 
#> 
#> Slot "cut_off_external":
#> An object of class "DataSimCutOff"
...
#>       data[data$enrollment < cut_time, ]
#>     }
#> <bytecode: 0x7f79b4792d68>
#> <environment: 0x7f79b47a0d68>
#> 
#> 
#> Slot "dropout_internal_treated":
#> An object of class "DataSimEvent"
...
#> Warning: Missing columns in fixed external data: enrollment
