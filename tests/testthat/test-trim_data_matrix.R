test_that("data matrix trimming works with BDB", {
  ...
  expect_matrix(anls1_trim@data_matrix, mode = "numeric", nrows = 50, ncols = 5)
  expect_set_equal(
...
test_that("data matrix trimming works with Full Borrowing", {
  ...
  expect_matrix(anls2_trim@data_matrix, mode = "numeric", nrows = 50, ncols = 3)
  expect_set_equal(
...
test_that("data matrix trimming works with No Borrowing", {
  ...
  expect_matrix(result@data_matrix, mode = "numeric", nrows = 22, ncols = 4)
  expect_set_equal(
