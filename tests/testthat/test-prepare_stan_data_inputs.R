...
test_that("prepare_stan_data_inputs returns correct matrix dimensions for X", {
  ...
  result1 <- psborrow2:::prepare_stan_data_inputs(object1@outcome, object1@borrowing, object1)
  ...
  result2 <- psborrow2:::prepare_stan_data_inputs(object2@outcome, object2@borrowing, object2)
