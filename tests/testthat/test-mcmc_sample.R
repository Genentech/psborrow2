...
test_that("mcmc_sample.Analysis() captures parameters of interest", {

  # Make comparable estimates----

  ## Full borrowing, exponential distribution ----
  ...
  expect_true(
    dplyr::near(full_exp_bayes$summary('HR_trt')[,'mean'][[1]],
                full_exp,
                tol = .05)
  )

  ## No borrowing, exponential distribution ----
