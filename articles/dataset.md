...
# 1 lp__     -1618.    -1618.    1.49   1.30   -1621.      -1.62e+3  1.00   73716.
# 2 beta_trt    -0.157    -0.159 0.199  0.198     -0.481    1.74e-1  1.00   85201.
# 3 alpha[1]    -3.36     -3.35  0.162  0.161     -3.63    -3.10e+0  1.00   85683.
# 4 alpha[2]    -2.40     -2.40  0.0554 0.0556    -2.49    -2.31e+0  1.00  124051.
# 5 tau          1.21      0.502 1.93   0.689      0.00442  4.81e+0  1.00   82311.
# 6 HR_trt       0.872     0.853 0.177  0.168      0.618    1.19e+0  1.00   85201.
...
#          chain
# iteration     1     2     3     4
#         1 -1617 -1618 -1622 -1618
#         2 -1618 -1617 -1620 -1617
#         3 -1619 -1617 -1619 -1616
#         4 -1619 -1617 -1620 -1617
#         5 -1619 -1617 -1616 -1619
# 
# , , variable = beta_trt
# 
#          chain
# iteration      1     2      3      4
#         1 -0.246 -0.39  0.432  0.204
#         2 -0.398 -0.12  0.280  0.140
#         3 -0.073 -0.27  0.124 -0.015
#         4  0.013 -0.33  0.074  0.111
#         5  0.077 -0.18 -0.169  0.146
# 
# , , variable = alpha[1]
# 
#          chain
...
#   variable          mean   median     sd    mad       q5      q95  rhat ess_bulk
#   <chr>            <dbl>    <dbl>  <dbl>  <dbl>    <dbl>    <dbl> <dbl>    <dbl>
# 1 lp__          -1.62e+3 -1.62e+3 1.49   1.30   -1.62e+3 -1.62e+3  1.00   73716.
# 2 treatment lo… -1.57e-1 -1.59e-1 0.199  0.198  -4.81e-1  1.74e-1  1.00   85201.
# 3 baseline log… -3.36e+0 -3.35e+0 0.162  0.161  -3.63e+0 -3.10e+0  1.00   85683.
# 4 baseline log… -2.40e+0 -2.40e+0 0.0554 0.0556 -2.49e+0 -2.31e+0  1.00  124051.
# 5 commensurabi…  1.21e+0  5.02e-1 1.93   0.689   4.42e-3  4.81e+0  1.00   82311.
# 6 treatment HR   8.72e-1  8.53e-1 0.177  0.168   6.18e-1  1.19e+0  1.00   85201.
# # ℹ 1 more variable: ess_tail <dbl>
```
...
#   <chr>                                   <dbl>      <dbl>
# 1 lp__                               -1620.     -1616.    
# 2 treatment log HR                      -0.410      0.0993
# 3 baseline log hazard rate, internal    -3.57      -3.15  
# 4 baseline log hazard rate, external    -2.47      -2.33  
# 5 commensurability parameter             0.0174     3.23  
# 6 treatment HR                           0.663      1.10
```
...
# 0.000636940 0.000662795 0.001266500
```
